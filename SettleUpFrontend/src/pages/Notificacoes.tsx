...
export const Notificacoes: React.FC = () => {
  ...
  const [transactionData, setTransactionData] = useState<{
    [key: string]: { destination: string; amount: string; memo: string };
  }>({});
  ...
  if (loading) {
    return (
      <div className="container mx-auto p-4">Carregando notificações...</div>
    );
  }
            ...
            >
              ...
              <div className="flex justify-end space-x-2">
                ...
                {notification.type === "fechamento do evento" && (
                  <Button
                    onClick={() =>
                      handleResponse(notification.id, "pago", notification.type)
                    }
                    text="Pagar"
                    variant="secondary"
                    disabled={mutation.isPending}
