...
const InviteQR: React.FC = () => {
  ...
  const inviteUrl = eventData ? `https://settleup.app/join/${eventData.id}` : '';
  ...
  return (
    <>
      <Head>
        <title>SettleUp - Convitar Participantes</title>
        <meta name="description" content={`Convide pessoas para o evento ${eventData.name}`} />
      </Head>
          ...
          <div className={styles.inviteContainer}>
            ...
            <div className={styles.manualInvite}>
              ...
              <div className={styles.inviteLinkContainer}>
                ...
                />
                <button 
                  className={`${styles.copyLinkBtn} ${copySuccess ? styles.copied : ''}`}
                  onClick={handleCopyLink}
                  type="button"
                >
                  <Copy size={16} />
